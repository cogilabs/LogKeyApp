...
class MesMoyensDePaiementActivity : AppCompatActivity() {
    ...
    lateinit var userCBcard : TextView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_mes_moyens_de_paiement)
        ...
        userCBcard = findViewById(R.id.numeroCarte)
        ...
        documentReference.addSnapshotListener(object : EventListener<DocumentSnapshot?> {
            override fun onEvent(
                ...
                if (error != null) {
                    ...
                    Toast.makeText(this@MesMoyensDePaiementActivity, "Error found is $error", Toast.LENGTH_SHORT)
                        .show()
                    return
                }
                if (value != null && value.exists()) {
                    ...
                    userCBcard.text = value.data!!["num_CBcard"].toString()
